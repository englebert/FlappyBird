...
void game_start()
{
    ...
    tft->setCursor( TFTW2 - (10 * 9), TFTH2 - 16);
    tft->println("FLAPPY");
    tft->setTextSize(3);
    tft->setCursor( TFTW2 - (10 * 9), TFTH2 + 8);
    tft->println("-BIRD-");
    tft->setTextSize(2);
    tft->setCursor( 10, TFTH2 - 36);
    tft->println("T-Watch 2020");
...
void game_over()
{
    ...
    if (score > maxScore) {
        ...
        tft->setTextSize(2);
        tft->setCursor( TFTW2 - (18 * 6), TFTH2 - 26);
    ...
    tft->setTextSize(3);
    // half width - num char * char width in pixels
    tft->setCursor( TFTW2 - (13 * 9), TFTH2 - 6);
    tft->println("GAME OVER");
    tft->setTextSize(2);
    tft->setCursor( 10, 10);
    tft->print("score: ");
    tft->print(score);
    tft->setCursor( TFTW2 - (15 * 6), TFTH2 + 18);
